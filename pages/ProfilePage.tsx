      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 px-6 py-3 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link className="text-slate-600 dark:text-slate-400 hover:text-primary text-sm font-medium transition-colors" to="/">Tableau de bord</Link>
            ...
            <Link className="text-primary text-sm font-bold border-b-2 border-primary pb-0.5" to="/profile">Mon Profil</Link>
          </nav>
      ...
      <main className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 flex items-center gap-2">
              <span className="material-symbols-outlined text-[18px]">history</span>
              Historique
            </button>
            <button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold hover:bg-red-700 transition-colors shadow-sm flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-slate-800 overflow-hidden flex flex-col">
            <div className="px-6 py-4 border-b border-gray-100 dark:border-slate-800 flex justify-between items-center bg-gray-50/50 dark:bg-slate-800/50">
              ...
              <button className="text-primary hover:text-red-700 p-1 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
            ...
            <div className="p-6 grid grid-cols-2 gap-y-6 gap-x-4">
              ...
              <div className="col-span-1">
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Date de naissance</p>
                <p className="text-slate-900 dark:text-white font-medium">14/05/1985</p>
              </div>
              <div className="col-span-1">
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Nationalité</p>
                <div className="flex items-center gap-2">
              ...
              <div className="col-span-2 pt-2 border-t border-dashed border-gray-200 dark:border-slate-700">
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Numéro Fiscal (NIF)</p>
                <div className="flex items-center gap-2">
            ...
            <div className="p-6 flex flex-col gap-6">
              <div>
                <div className="flex justify-between items-start mb-1">
                  <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider">Adresse E-mail</p>
                  <span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 px-2 py-0.5 text-xs font-medium text-emerald-700 dark:text-emerald-400 ring-1 ring-inset ring-emerald-600/20">
              ...
              <div>
                <div className="flex justify-between items-start mb-1">
                  <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider">Téléphone mobile</p>
                  <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 dark:bg-blue-900/20 px-2 py-0.5 text-xs font-medium text-blue-700 dark:text-blue-400 ring-1 ring-inset ring-blue-600/20">
              ...
              <div className="pt-2 border-t border-dashed border-gray-200 dark:border-slate-700">
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Préférences de communication</p>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-slate-800 overflow-hidden flex flex-col">
            ...
            <div className="p-6">
              <div className="flex items-start gap-4">
                <div className="h-20 w-20 shrink-0 rounded-lg bg-gray-100 dark:bg-slate-800 overflow-hidden" style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuA0xEFdA_bm0PdbU7szKpONWJALDKoj6Dl19ONQX1rfP9VfyOa8yk8oCEGFNNsppRtAhKWKDZyreXD0-xzIs98pIo3Xk8sNAIcYww2zI5QfmZDuB-LhS0_8Bd4qLPYXKEo92Wu_cc6GSdDFiB5rrL7gZmjOj-8pdlJYoMREIKhqFpW5mWZDh26qMObTOAnnO-eV0SwjZPHnWGa1ApTIW-kvnqRJZGFd-jsdlyqDONBlT99nydE5I7uxOKfgPK96n-Kt0d_z7JSB76c")', backgroundSize: 'cover', backgroundPosition: 'center'}}></div>
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex gap-2">
                    <span className="inline-flex items-center rounded-md bg-gray-100 dark:bg-slate-800 px-2 py-1 text-xs font-medium text-gray-600 dark:text-gray-300 ring-1 ring-inset ring-gray-500/10">Résidence principale</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-slate-800 overflow-hidden flex flex-col">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Situation professionnelle</p>
                <p className="text-slate-900 dark:text-white font-medium">Cadre Supérieur</p>
              </div>
              <div>
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Secteur d'activité</p>
                <p className="text-slate-900 dark:text-white font-medium">Finance & Banque</p>
              </div>
              <div>
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Revenu annuel estimé</p>
                <p className="text-slate-900 dark:text-white font-medium">80k - 120k €</p>
              </div>
              <div>
                <p className="text-slate-500 text-xs uppercase font-semibold tracking-wider mb-1">Origine des fonds</p>
        ...
        <section className="mb-10">
          <div className="flex justify-between items-end mb-4 px-1">
            ...
            <button className="text-primary text-sm font-semibold hover:text-red-700 flex items-center gap-1">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-800">
                <thead className="bg-gray-50 dark:bg-slate-800/50">
                  <tr>
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type de document</th>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">passeport_scan_2023.pdf</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white">12 Oct 2023</div>
                      <div className="text-xs text-gray-500">Exp. 14 Mai 2030</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center gap-1 rounded-full bg-green-50 dark:bg-green-900/20 px-2.5 py-0.5 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20">
                        Validé
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">facture_edf_octobre.jpg</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white">14 Oct 2023</div>
                      <div className="text-xs text-gray-500">Moins de 3 mois</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center gap-1 rounded-full bg-yellow-50 dark:bg-yellow-900/20 px-2.5 py-0.5 text-xs font-medium text-yellow-700 dark:text-yellow-400 ring-1 ring-inset ring-yellow-600/20">
        ...
        <footer className="border-t border-gray-200 dark:border-slate-800 pt-6 mt-12 pb-12">
          ...
          <p className="text-[10px] text-slate-300 dark:text-slate-500 mt-4 text-center md:text-left">
