...
const VirementBeneficiaryPage: React.FC = () => {
  ...
  const { beneficiaries, addBeneficiary, t } = useApp();
          ...
          <div className="mb-12 md:mb-16">
            <div className="relative flex items-center justify-between w-full max-w-2xl mx-auto px-2">
              ...
              <div className="relative z-10 flex flex-col items-center gap-2 md:gap-3">
                ...
                <span className="absolute top-10 md:top-14 text-[10px] md:text-sm font-bold text-slate-900 dark:text-white whitespace-nowrap">{t('transfers.step1')}</span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center gap-2 md:gap-3">
                ...
                <span className="absolute top-10 md:top-14 text-[10px] md:text-sm font-medium text-slate-400 whitespace-nowrap">{t('transfers.step2')}</span>
              </div>
          ...
          <div className="mt-8 md:mt-12 flex flex-col gap-8 md:gap-10">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-end">
              <div className="w-full">
                <label className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-300">{t('transfers.search_label')}</label>
              ...
              >
                ...
                <span className="hidden md:inline">{t('transfers.add_btn')}</span>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('transfers.fav_title')}</h3>
                <button className="text-sm font-semibold text-primary hover:underline">{t('common.see_all')}</button>
              </div>
            ...
            <div className="mt-4 md:mt-8 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-6 flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-slate-900 dark:text-white">{t('transfers.info_sepa_title')}</h4>
                <p className="text-sm text-slate-500 leading-relaxed">
                  {t('transfers.info_sepa_desc')}
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 md:mt-12 flex items-center justify-center gap-2 py-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <span className="text-sm text-slate-500">
                {t('transfers.help')} <a className="font-medium text-slate-900 dark:text-white hover:underline" href="#">{t('transfers.contact')}</a>
              </span>
            </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-y-auto animate-[fadeIn_0.2s_ease-out]">
            <div className="p-6 md:p-8 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center sticky top-0 bg-white dark:bg-slate-900 z-10">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">{t('transfers.add_btn')}</h2>
            ...
            <form onSubmit={handleAddSubmit} className="p-6 md:p-8 space-y-6">
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">{t('transfers.form.name')}</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">{t('transfers.form.iban')}</label>
                  <div className="relative">
                ...
                <div>
                    <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">{t('transfers.form.bank')}</label>
                    <div className="relative">
